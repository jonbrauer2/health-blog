...
description: "Arthritis, osteoporosis, sciatica, frozen shoulder, disc herniation, muscular dystrophy"
permalink: /health-papers/systems/musculoskeletal/
comments: false
exclude_from_papers: true
---

Arthritis, osteoporosis, sciatica, frozen shoulder, disc herniation, muscular dystrophy

[← All health papers](/health-papers/)

{% assign papers = site.pages | where_exp: "p", "p.path contains 'health-papers/'" | where_exp: "p", "p.exclude_from_papers != true" | where_exp: "p", "p.systems contains 'musculoskeletal'" | sort: "title" %}
{% if papers.size == 0 %}
