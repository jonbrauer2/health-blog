...
description: "Depression, bipolar, schizophrenia, agoraphobia, autism"
permalink: /health-papers/systems/mental-health/
comments: false
exclude_from_papers: true
---

Depression, bipolar, schizophrenia, agoraphobia, autism

[← All health papers]({{ "/health-papers/" | relative_url }})

{% assign papers = site.pages | where_exp: "p", "p.path contains 'health-papers/'" | where_exp: "p", "p.exclude_from_papers != true" | where_exp: "p", "p.systems contains 'mental-health'" | sort: "title" %}
{% if papers.size == 0 %}
