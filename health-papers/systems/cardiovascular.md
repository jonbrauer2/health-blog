...
description: "High blood pressure, hypotension, DVT, cardiovascular health"
permalink: /health-papers/systems/cardiovascular/
comments: false
exclude_from_papers: true
---

High blood pressure, hypotension, DVT, cardiovascular health

[← All health papers](/health-papers/)

{% assign papers = site.pages | where_exp: "p", "p.path contains 'health-papers/'" | where_exp: "p", "p.exclude_from_papers != true" | where_exp: "p", "p.systems contains 'cardiovascular'" | sort: "title" %}
{% if papers.size == 0 %}
