...
description: "Acne, rosacea, vitiligo, melasma, hives, ringworm, hair loss, melanoma"
permalink: /health-papers/systems/skin/
comments: false
exclude_from_papers: true
---

Acne, rosacea, vitiligo, melasma, hives, ringworm, hair loss, melanoma

[← All health papers]({{ "/health-papers/" | relative_url }})

{% assign papers = site.pages | where_exp: "p", "p.path contains 'health-papers/'" | where_exp: "p", "p.exclude_from_papers != true" | where_exp: "p", "p.systems contains 'skin'" | sort: "title" %}
{% if papers.size == 0 %}
